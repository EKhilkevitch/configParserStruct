...
#include "configParserStruct2/commandstack.h"
...
void CPSSPU_endOfWhileStatement( void ) 
{
  ...
  size_t IndexOfPlaceholer = Text->indexOfPlaceholder();
  Text->replacePlaceholder( configParserStruct::nopCommand() );
  Text->push( configParserStruct::jumpCommand(IndexOfPlaceholer+1) );
}
